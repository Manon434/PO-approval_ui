...
export default function PurchaseOrderAttachments({ poId, attachments, onAttachFiles, onRemoveAttachment }) {
  ...
  return (
    <section className="rounded-[24px] border border-slate-200 bg-white p-4 shadow-panel sm:rounded-[28px] sm:p-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="w-full sm:w-auto">
          ...
          <button
            ...
            className="inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-[#0070b1] px-4 py-3 text-sm font-semibold text-white transition hover:bg-[#005d91] sm:w-auto"
          >
